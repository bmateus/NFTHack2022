...
const description = "Dungeon Adventurers";
// base url in case no unique metadata file i.e IPFS
const baseImageUri = "https://y8emtia93i9r.bigmoralis.com:2053/server";
...
let rarityWeights = [
  addRarity("common", 0, editionSize),
  addRarity("rare", 0, editionSize),
];
...
addRarityPercentForLayer("common", "Body", {
  rare: 20,
  common: 100,
});

addRarityPercentForLayer("common", "Eyes", {
  rare: 20,
  common: 100,
});

addRarityPercentForLayer("common", "Mouth", {
  rare: 20,
  common: 100,
});

addRarityPercentForLayer("common", "Noses", {
  rare: 20,
  common: 100,
});
